    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      {whatsapp && (
        <a
          ...
          className="group relative w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-[#25D366]/30 hover:shadow-[#25D366]/50 hover:scale-110 transition-all duration-300 animate-fade-in"
          title="WhatsApp"
        >
          ...
          <span className="absolute right-16 bg-[#1a1a2e] text-white text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-lg">WhatsApp</span>
        </a>
      )}
      {telegram && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group relative w-14 h-14 rounded-full bg-[#0088cc] flex items-center justify-center shadow-lg shadow-[#0088cc]/30 hover:shadow-[#0088cc]/50 hover:scale-110 transition-all duration-300"
          title="Telegram"
        >
          ...
          <span className="absolute right-16 bg-[#1a1a2e] text-white text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-lg">Telegram</span>
        </a>
      )}
    </div>
  );
