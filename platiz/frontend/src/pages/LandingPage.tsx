      ...
      <motion.section ref={heroRef} style={{ y: heroY }}
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut" }}
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.8 }}
            ...
            Ecosistema digital de alta gama con acceso vitalicio. Capacitacion especializada en viralidad, el arsenal de software y servicios digitales mas completo del mercado, y oportunidades reales de ingresos como promotor.
          </motion.p>
