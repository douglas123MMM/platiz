      ...
      <div className="bg-gradient-to-b from-black to-transparent py-6 text-center px-4">
        ...
        <div className="flex justify-center gap-3 mt-3">
          ...
          {affiliate?.telegram_link && (
            <a
              href={affiliate.telegram_link.startsWith('http') ? affiliate.telegram_link : `https://t.me/${affiliate.telegram_link.replace('@', '')}`}
              target="_blank" rel="noopener noreferrer"
          ...
          <div className="flex justify-center gap-2 mt-3 flex-wrap">
            {affiliate.instagram && (
              <a href={`https://instagram.com/${affiliate.instagram.replace('@','').replace('instagram.com/','')}`} target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-1 px-3 py-1.5 bg-gradient-to-r from-[#833AB4] to-[#E1306C] text-white text-xs rounded-full font-bold shadow-lg shadow-purple-500/20">
                ...
                {affiliate.instagram.replace('@','').replace('https://instagram.com/','')}
              </a>
            )}
            {affiliate.tiktok && (
              <a href={`https://tiktok.com/${affiliate.tiktok.replace('@','').replace('tiktok.com/','')}`} target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-1 px-3 py-1.5 bg-black border border-white/20 text-white text-xs rounded-full font-bold shadow-lg">
                ...
                {affiliate.tiktok.replace('@','').replace('https://tiktok.com/','')}
              </a>
            )}
            {affiliate.facebook && (
              <a href={`https://facebook.com/${affiliate.facebook.replace('facebook.com/','')}`} target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-1 px-3 py-1.5 bg-[#1877F2] text-white text-xs rounded-full font-bold shadow-lg shadow-blue-500/20">
                ...
                {affiliate.facebook.replace('https://facebook.com/','')}
              </a>
            )}
            {affiliate.youtube && (
              <a href={`https://youtube.com/${affiliate.youtube.replace('@','').replace('youtube.com/','')}`} target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-1 px-3 py-1.5 bg-[#FF0000] text-white text-xs rounded-full font-bold shadow-lg shadow-red-500/20">
                ...
                {affiliate.youtube.replace('@','').replace('https://youtube.com/','')}
              </a>
            )}
          </div>
        )}
