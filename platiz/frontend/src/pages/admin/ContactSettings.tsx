...
export default function ContactSettings() {
  ...
  const [binancePayEmail, setBinancePayEmail] = useState('');
  const [binancePayQr, setBinancePayQr] = useState('');
  ...
  useEffect(() => {
    api.get('/settings').then((r) => {
      ...
      setBinancePayId(r.data.binance_pay_id || '');
      setBinancePayEmail(r.data.binance_pay_email || '');
      setBinancePayQr(r.data.binance_pay_qr || '');
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      await api.put('/settings', { whatsapp, telegram, bcv_rate: bcvRate, binance_pay_id: binancePayId, binance_pay_email: binancePayEmail, binance_pay_qr: binancePayQr, guias });
  ...
  if (loading) return <div className="text-center py-12"><div className="w-8 h-8 border-2 border-[#E5C158]/30 border-t-[#E5C158] rounded-full animate-spin mx-auto" /></div>;

  return (
    <div className="space-y-6 animate-fade-in max-w-2xl">
      <div className="flex items-center gap-3">
        <HiPhone className="w-8 h-8 text-[#E5C158]" />
      ...
      <div className="glass rounded-2xl p-6 border border-[#E5C158]/10">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="p-4 bg-[#E5C158]/10 rounded-xl flex items-center gap-3">
          ...
          <div className="mt-8 pt-6 border-t border-[#E5C158]/10">
            <div className="p-4 bg-[#F0B90B]/10 rounded-xl flex items-center gap-3 mb-4">
              <span className="text-2xl">₿</span>
              <div><p className="text-white font-medium">Configuración de Pagos Binance</p><p className="text-gray-400 text-xs">Datos de pago que ven los clientes al recargar</p></div>
            </div>
              ...
              <div>
                ...
                {binancePayQr && (
                  <div className="mt-3 relative inline-block">
                    <img src={binancePayQr} alt="QR Binance" className="w-40 h-40 rounded-xl border border-[#E5C158]/10 object-contain bg-white" />
                    <button
          ...
          <div className="mt-8 pt-6 border-t border-[#E5C158]/10">
            <div className="flex items-center gap-3 mb-4">
              <svg viewBox="0 0 24 24" className="w-8 h-8 fill-[#E5C158]"><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-1 9H9V9h10v2zm-4 4H9v-2h6v2zm4-8H9V5h10v2z"/></svg>
