        ...
        <div className="text-center px-4 mb-8">
          ...
          {(affiliate.instagram || affiliate.tiktok || affiliate.facebook || affiliate.youtube) && (
            <div className="flex justify-center gap-2 mt-3">
              {affiliate.instagram && (
                <a href={affiliate.instagram.startsWith('http') ? affiliate.instagram : `https://instagram.com/${affiliate.instagram.replace('@','')}`} target="_blank" rel="noopener noreferrer"
              ...
              {affiliate.tiktok && (
                <a href={affiliate.tiktok.startsWith('http') ? affiliate.tiktok : `https://tiktok.com/@${affiliate.tiktok.replace('@','')}`} target="_blank" rel="noopener noreferrer"
              ...
              {affiliate.facebook && (
                <a href={affiliate.facebook.startsWith('http') ? affiliate.facebook : `https://facebook.com/${affiliate.facebook}`} target="_blank" rel="noopener noreferrer"
              ...
              {affiliate.youtube && (
                <a href={affiliate.youtube.startsWith('http') ? affiliate.youtube : `https://youtube.com/${affiliate.youtube.replace('@','')}`} target="_blank" rel="noopener noreferrer"
